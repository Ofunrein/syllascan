      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="liquid-glass rounded-2xl overflow-hidden text-white">
          ...
          <div className="p-6">
            ...
            <ol className="list-decimal pl-5 mb-6 space-y-2 text-white/65">
      ...
      <div className="liquid-glass rounded-2xl p-6 text-white">
        ...
        {error.includes('authorization expired') || error.includes('reconnect') ? (
          <div className="flex space-x-2">
            ...
            <button
              onClick={fetchGoogleCalendarEvents}
              className="px-4 py-2 bg-white/10 text-white rounded-full hover:bg-white/15 transition"
            >
              Try Again
            </button>
          </div>
        ...
        <div className="liquid-glass rounded-2xl overflow-hidden text-white">
          ...
          <div className="p-6 flex flex-col items-center justify-center">
            <div className="text-center mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-white/45 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              onClick={handleConnectGoogleCalendar}
              className="flex items-center px-4 py-2 bg-white border border-white rounded-full shadow-sm text-sm font-medium text-black hover:bg-white/85 focus:outline-none"
            >
    ...
    <div className="w-full max-w-4xl mx-auto">
      <div className="liquid-glass rounded-2xl overflow-hidden text-white">
        ...
        <div className="px-6 py-4 flex justify-between items-center border-t border-white/10">
          ...
          <button
            onClick={fetchGoogleCalendarEvents}
            className="px-3 py-1 bg-white/10 text-white rounded-full hover:bg-white/15 transition text-sm flex items-center"
          >
