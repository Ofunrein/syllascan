      ...
      <div className="liquid-glass rounded-2xl overflow-hidden text-white">
        ...
        <div className="relative pb-[75%] h-0 overflow-hidden">
          ...
          ></iframe>
            ...
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-white/5">
              <p className="text-white/55">Please sign in to view your calendar</p>
            </div>
          )}
        </div>
